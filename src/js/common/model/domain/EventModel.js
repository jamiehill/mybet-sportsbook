import Incidents from 'common/model/Incidents';
import TennisIncidents from 'common/model/TennisIncidents';
import EventDataSync from 'trading/model/EventDataSync';


var Model = Marionette.Controller.extend({
	// TODO
	//dependencies: 'streamingService, cache=eventCache, keyMarketsModel, eventScheduleModel,  frontPageModel, popularBetsModel, commands, vent',
	//incidentEventXref:[],
	...
	//    _.bindAll(this,'onLoginSuccess','onEventDataSync');
	//    this.listenTo(this.eventScheduleModel, 'change:inplay', this.onInplayScheduleChange);
	//    this.listenTo(this.streamingService, 'streaming:eventTradingState', this.onEventTradingStateChange);
	//    this.listenTo(this.streamingService, 'streaming:incidents', this.onIncidentsChange);
	//    this.listenTo(this.streamingService, 'streaming:event', this.onEventChange);
	//    this.listenTo(this.streamingService, 'streaming:subscribeResponse', this.onSubscribeResponse);
	//    this.listenTo(this.streamingService, 'streaming:scheduleAmendment', this.onScheduleAmendmentChange);
	//    this.listenTo(this.streamingService, 'streaming:eventDataSync', this.onEventDataSync);
	//
	//    this.listenTo(this.vent, 'session:loggedin', this.onLoginSuccess);
	//    this.listenTo(this.vent, 'schedule:add:inplay', this.onScheduleAddInplay);
	//},
	//
	//
	///**
	...
	//        this.vent.trigger('event:numMarkets:change',event);
	//    }
	//},
	//
	//
	...
	//    eventChangeObj.changed = event.changed;
	//
	//    this.vent.trigger('event:marketChange', eventChangeObj);
	//},
	//
	//
	///**
	...
	//    var event = this.cache.getEvent(eventTradingState.id);
	//    if (event) {
	...
	//        this.vent.trigger('incidents:timerChange', incidentModel);
	//    }
	//
	//    if(incidentModel.attributes.type == 'PeriodStart')
	//        this.vent.trigger('incidents:periodStart', incidentModel);
	//},
	//
